  ...
  return (
    <div className='admin-container'>
      ...
      <form onSubmit={handleSubmit} className='admin-form'>
            ...
            <input type='number' value = {age} placeholder="Level" onChange={(e)=>{setAge(e.target.value)}}/><br/>
            <input type='text' value = {disease} placeholder="Disaster" onChange={(e)=>{setDisease(e.target.value)}}/><br/>
      ...
      <div className='table-container'>
        ...
        {popUp && 
            <form onSubmit={updateData} className='admin-form'>
                ...
                <input type='number' value = {newage} placeholder='Level' onChange={(e)=>{setnewAge(e.target.value)}}/><br/>
                <input type='text' value = {newdisease} placeholder="Disaster" onChange={(e)=>{setnewDisease(e.target.value)}}/><br/>
